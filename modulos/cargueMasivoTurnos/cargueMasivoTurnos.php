            ...
            <div class="col-12">
                <div class="card ancho">
                    <div class="card-header">
                        <h5 class="card-title titulo">Cargue masivo turnos Madrid</h5>
                                                    ...
                                                    if ($lunes !== NULL) {
                                                        ...
                                                        $sqlLunes = "INSERT INTO `{$wpdb->prefix}co_turnos`  (`idMeta`, `centro`, `apellido`, `nombre`,
                                                                ...
                                                                '$descanso1', '$descanso2', '$descanso3', '$horaHastas', '$pausa1', '$pausa2',
                                                                    '$pausa3', '$pausa4', '$pausa5', '$pausa6', '$pausa7', '$pausa8', '$semana','$obra', '$quienCrea', '$semanaAnio2','$lunes', '$camp','ESPANA','Lunes','$anoDesL-$mesDesL-$diaDesL', '$categoria');";
                                                    ...
                                                    if ($martes !== NULL) {
                                                        ...
                                                        $sqlMartes = "INSERT INTO `{$wpdb->prefix}co_turnos`  (`idMeta`, `centro`, `apellido`, `nombre`,
                                                                ...
                                                                '$descanso20', '$descanso30', '$descanso10', '$horaHastas', '$pausa1', '$pausa2',
                                                                    '$pausa3', '$pausa4', '$pausa5', '$pausa6', '$pausa7', '$pausa8', '$semana','$obra', '$quienCrea', '$semanaAnio2','$martes', '$camp','ESPANA','Martes','$anoDesM-$mesDesM-$diaDesM', '$categoria');";
                                                    ...
                                                    if ($miercoles !== NULL) {
                                                        ...
                                                        $sqlMiercoles = "INSERT INTO `{$wpdb->prefix}co_turnos`  (`idMeta`, `centro`, `apellido`, `nombre`,
                                                                ...
                                                                `pausa8`, `semanal`,`obra`, `quienCarga`, `semanaAnio`, `codigo` , `campania`  ,`lugar`,`dia`,`fechaDia`,`categoria`) VALUES ('$idMeta', '$centro', '$apellido', 
                                                                    '$nombre', '$numeroEmpleado', '$servicio', '$duracionTurno', '$horaDesde',
                                                                '$descanso20', '$descanso30', '$descanso10', '$horaHastas', '$pausa1', '$pausa2',
                                                                    '$pausa3', '$pausa4', '$pausa5', '$pausa6', '$pausa7', '$pausa8', '$semana','$obra', '$quienCrea', '$semanaAnio2','$miercoles', '$camp','ESPANA','Miercoles','$anoDesMi-$mesDesMi-$diaDesMi', '$categoria');";
                                                    ...
                                                    if ($jueves !== NULL) {
                                                        ...
                                                        $sqlJueves = "INSERT INTO `{$wpdb->prefix}co_turnos`  (`idMeta`, `centro`, `apellido`, `nombre`,
                                                                ...
                                                                `pausa8`, `semanal`,`obra`, `quienCarga`, `semanaAnio`, `codigo` , `campania`  ,`lugar`,`dia`,`fechaDia`,`categoria`) VALUES ('$idMeta', '$centro', '$apellido', 
                                                                    '$nombre', '$numeroEmpleado', '$servicio', '$duracionTurno', '$horaDesde',
                                                                '$descanso20', '$descanso30', '$descanso10', '$horaHastas', '$pausa1', '$pausa2',
                                                                    '$pausa3', '$pausa4', '$pausa5', '$pausa6', '$pausa7', '$pausa8', '$semana','$obra', '$quienCrea', '$semanaAnio2','$jueves', '$camp','ESPANA','Jueves','$anoDesJ-$mesDesJ-$diaDesJ', '$categoria');";
                                                    ...
                                                    if ($viernes !== NULL) {
                                                        ...
                                                        $sqlViernes = "INSERT INTO `{$wpdb->prefix}co_turnos`  (`idMeta`, `centro`, `apellido`, `nombre`,
                                                                ...
                                                                `pausa8`, `semanal`,`obra`, `quienCarga`, `semanaAnio` , `codigo` , `campania`   ,`lugar`,`dia`,`fechaDia`,`categoria`) VALUES ('$idMeta', '$centro', '$apellido', 
                                                                    '$nombre', '$numeroEmpleado', '$servicio', '$duracionTurno', '$horaDesde',
                                                                '$descanso20', '$descanso30', '$descanso10', '$horaHastas', '$pausa1', '$pausa2',
                                                                    '$pausa3', '$pausa4', '$pausa5', '$pausa6', '$pausa7', '$pausa8', '$semana','$obra', '$quienCrea', '$semanaAnio2','$viernes', '$camp','ESPANA','Viernes','$anoDesV-$mesDesV-$diaDesV', '$categoria');";
                                                    ...
                                                    if ($sabado !== NULL) {
                                                        ...
                                                        $sqlSabado = "INSERT INTO `{$wpdb->prefix}co_turnos`  (`idMeta`, `centro`, `apellido`, `nombre`,
                                                                ...
                                                                `pausa8`, `semanal`,`obra`, `quienCarga`, `semanaAnio`, `codigo` , `campania`  ,`lugar`,`dia`,`fechaDia`,`categoria`) VALUES ('$idMeta', '$centro', '$apellido', 
                                                                    '$nombre', '$numeroEmpleado', '$servicio', '$duracionTurno', '$horaDesde',
                                                                '$descanso20', '$descanso30', '$descanso10', '$horaHastas', '$pausa1', '$pausa2',
                                                                    '$pausa3', '$pausa4', '$pausa5', '$pausa6', '$pausa7', '$pausa8', '$semana','$obra', '$quienCrea', '$semanaAnio2','$sabado', '$camp','ESPANA','Sabado','$anoDesS-$mesDesS-$diaDesS', '$categoria');";
                                                    ...
                                                    if ($domingo !== NULL) {
                                                        ...
                                                        $sqlDomingo = "INSERT INTO `{$wpdb->prefix}co_turnos`  (`idMeta`, `centro`, `apellido`, `nombre`,
                                                                ...
                                                                `pausa8`, `semanal`,`obra`, `quienCarga`, `semanaAnio`, `codigo` , `campania`  ,`lugar`,`dia`,`fechaDia`,`categoria`) VALUES ('$idMeta', '$centro', '$apellido', 
                                                                    '$nombre', '$numeroEmpleado', '$servicio', '$duracionTurno', '$horaDesde',
                                                                '$descanso20', '$descanso30', '$descanso10', '$horaHastas', '$pausa1', '$pausa2',
                                                                    '$pausa3', '$pausa4', '$pausa5', '$pausa6', '$pausa7', '$pausa8', '$semana','$obra', '$quienCrea', '$semanaAnio2','$domingo', '$camp','ESPANA','Domingo','$anoDesD-$mesDesD-$diaDesD', '$categoria');";
