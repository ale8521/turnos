                            ...
                            <form class="form">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 bajarBotones" >
                                        <button type="button"  onclick="buscarEspa()" class="btn btn-primary me-1 mb-1">Buscar</button>
                                        <button type="button" onclick="LimpiarEspa()" class="btn btn-primary me-1 mb-1">Limpiar</button>
                                    </div>
                                </div>
                            </form>
                            <br>
