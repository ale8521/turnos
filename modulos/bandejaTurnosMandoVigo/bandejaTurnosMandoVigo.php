            ...
            <div class="col-12">
                <div class="card ancho">
                    <div class="card-header">
                        <h5 class="card-title titulo">Turnos Vigo</h5>
                    </div>
                            ...
                            <form class="form">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 bajarBotones" >
                                        <button type="button"  onclick="buscarVigo()" class="btn btn-primary me-1 mb-1">Buscar</button>
                                        <button type="button" onclick="LimpiarVigo()" class="btn btn-primary me-1 mb-1">Limpiar</button>
                                    </div>
                                </div>
                            </form>
                            <br>
