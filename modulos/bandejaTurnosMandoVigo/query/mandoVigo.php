...
$consulta = "SELECT      *,
    ...
    FROM 
        ...
        where semanaAnio = '$semanaAnio' AND lugar = 'VIGO' order by fechaDia";
...
<script type="text/javascript">
    $(document).ready(function () {
        $('td.editable-col').on('focusout', function () {
            ...
            $.ajax({
                type: "POST",
                url: "../wp-content/plugins/turnos/modulos/bandejaTurnosMandoVigo/query/editarCelda.php",
                cache: false,
            ...
            if (deleteids_arr.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            url: '../wp-content/plugins/turnos/modulos/bandejaTurnosMandoVigo/query/eliminar.php',
                            type: 'POST',
